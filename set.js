...
module.exports = { session: process.env.SESSION_ID || 'BELTAH-MD',
   ...
   CHATBOT : process.env.CHATBOT || "no",
    ...
    DATABASE: DATABASE_URL === databasePath
        ? "postgresql://beltahke:CdiT5wd6lnosDJyqVtiuHMAeB64DU24b@dpg-d12fn6juibrs73f61n0g-a.oregon-postgres.render.com/beltahtechpg" : "postgres://db_7xp9_user:6hwmTN7rGPNsjlBEHyX49CXwrG7cDeYi@dpg-cj7ldu5jeehc73b2p7g0-a.oregon-postgres.render.com/db_7xp9",
    /* new Sequelize({
     dialect: 'sqlite',
